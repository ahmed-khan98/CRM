...
const TimeCounter = ({ timeDisplay, status, price }) => {
  ...
  return (<div className=" text-center py-3 flex justify-center">
      <div className="mx-2 w-[42%] bg-white rounded-lg py-2 shadow">
      <span className="text-sm text-gray-700">{status === "upcoming" ? "Coming Soon" :  status === "ended" ?'Ended' :"Time Left"}</span>
