...
const ProductRowCard = ({ item, index,handleRefetch }) => {
    ...
    return (
        <div className="bg-white border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 p-3 mbg-zinc-800 border-2 hover:border-[#F33E0A]">
            {/* mobile */}
