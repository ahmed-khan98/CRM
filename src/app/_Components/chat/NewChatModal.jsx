...
function NewChatModal({
  ...
  const [selected, setSelected] = useState([]); // [{_id, fullName, image, email}]
          ...
          <div className="flex gap-2 text-xs">
            <button
              ...
              className={`rounded-full px-3 py-1 font-medium ${
                mode === "direct" ? "bg-zinc-950 text-white" : "bg-zinc-100"
              }`}
            >
              Direct
            </button>
            {canCreateGroup ? (
              <button
                ...
                className={`rounded-full px-3 py-1 font-medium ${
                  mode === "group" ? "bg-zinc-950 text-white" : "bg-zinc-100"
                }`}
              >
                Group
              </button>
            ...
            {(users || []).map((u) => {
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    if (mode === "direct") onPickDirect(u._id);
                    else toggleMember(u);
                  }}
                >
                  <Avatar
