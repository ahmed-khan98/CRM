...
export default function GenZForgetForm() {
  ...
  <Link href="/" className="mx-auto">
            <Image src={Main} alt="Logo"  />
              ...
              <h2 className="text-2xl font-bold mb-1 text-[#FB3B11]">Forgot Password?</h2>
            ...
            <form onSubmit={formik.handleSubmit} className="space-y-5">
              ...
              <motion.button
                ...
                className="w-full bg-[#FB3B11] hover:bg-[#e03610] cursor-pointer text-white py-3.5 rounded-xl font-medium flex items-center justify-center disabled:opacity-70 transition-all"
              >
                {isSubmitting ? (
