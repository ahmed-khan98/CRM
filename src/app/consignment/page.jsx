...
import { useGetConsignmentQuery } from '../_Services/services/page';


const page = () => {

  const { data, isLoading, error } = useGetConsignmentQuery();
    ...
    <div className='container mx-auto pt-[50px] md:my-12 my-5 px-12 md:px-6'>
      {isLoading ? (
       ...
       <>
        ...
        <div className="w-full flex justify-center items-center h-[50vh]">
          <p className="text-gray-500 text-lg font-semibold">Consignment Page Not Found</p>
        </div>
      )}
