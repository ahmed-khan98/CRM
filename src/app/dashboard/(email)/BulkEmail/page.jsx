...
import { useAllBulkEmailsQuery } from "@/app/_Services/sentEmail/page";
...
const BulkEmailsPage = () => {
  ...
  const { data, error, isLoading, refetch } = useAllBulkEmailsQuery({
    page,
    limit,
  });   
      ...
      >
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.99 }}
            onClick={() => router.push("/dashboard/SentBulkEmail")}
