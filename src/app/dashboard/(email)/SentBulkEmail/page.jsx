...
import { useSentBulkEmailMutation } from "@/app/_Services/sentEmail/page";
import { useAllEmailListsQuery } from "@/app/_Services/emaillist/page";
import { useAllBrandsQuery } from "@/app/_Services/brand/page";

export default function page() {
  const [sentBulkEmail] = useSentBulkEmailMutation();
