      ...
      <Tab tabs={helpTabs}/>
        ...
        >
          ...
          {isLoading ? (
            <div className="grid gap-4">
              {[...Array(3)].map((_, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 animate-pulse">
                  <div className="h-6 bg-gray-200 rounded w-1/3 mbg-zinc-800"></div>
                  <div className="h-4 bg-gray-200 rounded w-full mb-2"></div>
                  <div className="h-4 bg-gray-200 rounded w-2/3 mbg-zinc-800"></div>
            ...
            >
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mbg-zinc-800">
                ...
                {filteredData?.map((item, index) => (
                  ...
                  >
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 text-sm mbg-zinc-800 line-clamp-2">{item.message}</p>
