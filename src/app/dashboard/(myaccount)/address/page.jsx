...
import { User, MapPin, Edit2, Save, CheckCircle, Loader2, } from "lucide-react"
    ...
    return (
        <div className="min-h-screen  py-4 px-4">
            ...
            <div className="max-w-5xl mx-auto pt-4">
                ...
                <div className="my-6">
                    <h1 className="text-xl md:text-2xl font-bold text-gray-800">Address Details</h1>
                            ...
                            {isEditable && (
                                ...
                                >
                                    <button
                                        type="submit"
                                        disabled={isLoading}
                                        className="group relative cursor-pointer overflow-hidden px-8 py-4 bg-[#F33E0A] text-white font-medium rounded-full hover:shadow-lg transition-all duration-300 disabled:opacity-70 min-w-[200px]"
                                    >
